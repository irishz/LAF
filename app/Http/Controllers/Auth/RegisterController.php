    ...
    */
    ...
    protected function validator(array $data)
    {
        return Validator::make($data, [
            ...
            'user_id.required' => ['กรุณาใส่รหัสพนักงาน'],
    ...
    public function showRegistrationForm(){
        ...
        $position = ['ผู้จัดการ','ผช.ผู้จัดการ','หัวหน้าแผนก','รักษาการหัวหน้าแผนก','พยาบาลวิชาชีพ(RN)','เภสัชกร','นักเทคนิคการแพทย์','นักรังสีเทคนิค'
            ...
            ,'จนท.ศูนย์จัดการยุทธศาสตร์องค์กร','จนท.ประสานสิทธิ์','จนท.ทันตกรรม','จนท.OCC','ผช.พยาบาล (PN)','พนง.ผช.พยาบาล (NA)','พนง.ยานยนต์','พนง.รับ-ส่งผู้ป่วย','ผช.นักเทคนิคการแพทย์ (LAB)'
            ,'ผช.นักรังสีเทคนิค (X-RAY)','ผช.เภสัชกร','ผช.ทันตกรรม','พนง.โภชนาการ','ช่างซ่อมบำรุง','แมสเซ็นเจอร์','แม่บ้าน','รปภ','Sale/เซเรน่า'
        ];
